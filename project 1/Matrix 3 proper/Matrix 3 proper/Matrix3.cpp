...
const Matrix3 Matrix3::rotation(int _angle)
{
...
const Matrix3 Matrix3::RotationX(int _angle)
{
	double radians = PI / 180 * _angle;
	Matrix3 answer = Matrix3();
	answer.A11 = 1;
...
const Matrix3 Matrix3::RotationY(int _angle)
{
	double radians = PI / 180 * _angle;
	Matrix3 answer = Matrix3();
	answer.A11 = std::cos(radians);
...
const Matrix3 Matrix3::RotationZ(int _angle)
{
	double radians = PI / 180 * _angle;
	Matrix3 answer =Matrix3();
	answer.A11 = std::cos(radians);
